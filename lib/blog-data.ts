...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: "Explore the latest web design trends that are shaping the digital landscape.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Learn how to create performant and scalable web applications using Next.js.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Discover the latest SEO techniques to improve your website's visibility.",
    content: `
  ...
  },
  {
    ...
    excerpt: "Essential design principles for creating user-friendly mobile applications.",
    content: `
