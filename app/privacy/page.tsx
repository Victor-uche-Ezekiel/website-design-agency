    ...
    <main className="flex-1">
      <div className="container relative">
        <motion.div
          ...
          className="max-w-4xl mx-auto py-12 md:py-16 lg:py-20"
        >
          <h1 className="text-4xl font-bold mb-8">Privacy Policy</h1>
          <p className="text-muted-foreground mb-8">Last updated: February 17, 2023</p>
          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <ul>
              ...
              <li>
                ...
                "Us" or "Our" in this Agreement) refers to our web design agency.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to our web design agency website.
              </li>
              <li>
