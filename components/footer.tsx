        ...
        <div className="py-12 border-b">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Subscribe to our newsletter for the latest design trends, tips, and insights.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-3 text-muted-foreground hover:text-primary transition-colors group">
                ...
                <a href="mailto:hello@pixelperfect.com" className="hover:underline">hello@pixelperfect.com</a>
              </li>
              <li className="flex items-center space-x-3 text-muted-foreground hover:text-primary transition-colors group">
              ...
              <li className="flex items-start space-x-3 text-muted-foreground">
                ...
                <span>123 Design Street,<br />Creative City, DC 10001</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="py-6 border-t">
          <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
            <p className="text-muted-foreground text-sm">
              &copy; {new Date().getFullYear()} PixelPerfect. All rights reserved.
            </p>
